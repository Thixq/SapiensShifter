...
// ignore_for_file: prefer_single_quotes, avoid_renaming_method_parameters, lines_longer_than_80_chars
  ...
  static const Map<String, dynamic> tr = {
    ...
    "all_exception": {
      ...
      "firebase_auth_exception": {
        ...
        "user_not_found":
            "Bu e-posta adresiyle ilişkili bir kullanıcı bulunamadı.",
        "wrong_password": "Hatalı şifre girdiniz.",
        "email_already_use":
            "Bu e-posta adresi zaten bir hesapla ilişkilendirilmiş.",
        "weak_password": "Şifre çok zayıf. Lütfen daha güçlü bir şifre seçin.",
        "requires_recent_login":
            "Bu işlem yakın zamanda giriş yapmayı gerektirir. Lütfen tekrar giriş yapın.",
      ...
      "social_credential_exception": {
        ...
        "canceled_user":
            "Oturum açma işlemi kullanıcı tarafından iptal edildi.",
      },
    },
  };
